...
class ProtoTypicalNet2(nn.Module):
    def __init__(self, embedding, embedding_dim, hidden_dim, num_class, dropout=0.5, requires_grad=False):
        ...
        # 对多标签编码
        self.label_embedding = nn.Parameter(torch.randn(num_class, hidden_dim * 2))
        # 原型网络核心
