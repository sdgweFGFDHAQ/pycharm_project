...
def set_jieba():
    # 设置不可分割的词
    # jieba.load_userdict("./words/cityname.txt")
    # jieba.load_userdict("./words/statename.txt")
    # jieba.load_userdict("./words/distinctname.txt")
    # jieba.load_userdict("./words/namenoise.txt")
    # jieba.load_userdict("./words/symbol.txt")
    jieba.load_userdict("./words/stopwords.txt")
